...
public class ScoreEleAlgaeHigh extends Command {
  Elevator e_Elevator;
  /** Creates a new ScoreL2Position. */
  public ScoreEleAlgaeHigh(Elevator e_Elevator) {
  ...
  @Override
  public void execute() {
    e_Elevator.setScoreTargetPosition(Constants.SCORE_ELEVATOR_REMOVE_ALGAE_HIGH);
  }
