...
public class SetScoreRightShallowandUpdate extends SequentialCommandGroup {
  /** Creates a new SetScoreLeftandUpdate. */
  public SetScoreRightShallowandUpdate(Score s_Score) {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(
      new ScoreRightState(s_Score),
      new ScoreSetScoreShallow(s_Score)
    );
  }
}
