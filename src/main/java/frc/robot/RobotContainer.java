...
public class RobotContainer {
    ...
    private void configureBindings() {
        ...
        joystick.x().whileTrue(new ElevatorHigh(elevatorSubsytem));
        joystick.y().whileTrue(new EleDown(elevatorSubsytem));
        joystick.a().whileTrue(new EleHome(elevatorSubsytem));
        joystick.b().whileTrue(new EleMiddle(elevatorSubsytem));
    }
